...
#pprint(categories)
open('categories.json', 'w').write(json.dumps(categories, sort_keys=True, indent=4, separators=(',', ': ')))
open('slugs.json', 'w').write(json.dumps(slugs, sort_keys=True, indent=4, separators=(',', ': ')))
open('ids.json', 'w').write(json.dumps(catids, sort_keys=True, indent=4, separators=(',', ': ')))
